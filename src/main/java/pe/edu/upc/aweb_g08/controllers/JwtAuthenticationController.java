...
import pe.edu.upc.aweb_g08.dtos.JwtRequestDTO;
import pe.edu.upc.aweb_g08.dtos.JwtResponseDTO;
import pe.edu.upc.aweb_g08.entities.Usuario;
import pe.edu.upc.aweb_g08.securities.JwtTokenUtil;
import pe.edu.upc.aweb_g08.serviceimplements.JwtUserDetailsService;
...
public class JwtAuthenticationController {
    ...
    public ResponseEntity<JwtResponseDTO> login(@RequestBody JwtRequestDTO req) throws Exception {
        authenticate(req.getEmail(), req.getContrasenia());
